...
public class Menu {
	...
	private void trabajo(int opcion) {
		...
		case 1:
			...
			apellidos=tec.next();
			if(a.añadeContacto(nombre, apellidos)) System.out.println("Añadido con éxito");
			break;
		case 2:
			System.out.println("Dime el nombre de tu contacto");
			nombre=tec.next();
			System.out.println("Dime los apellidos de tu contacto");
			apellidos=tec.next();
			if(a.borrarContacto(nombre, apellidos)) System.out.println("Borrado con éxito");
		...
		case 5:
			...
			a.añadirTelefono(nombre, apellidos, telefono, tipotelefono);
			break;
		case 6:
			System.out.println("Dime el nombre de tu contacto");
			nombre=tec.next();
		...
		case 8:
			...
			break;
		case 9:
			for(Hombre x: a.hombres) {
				System.out.println(x);
			}
			for(Mujer x: a.mujeres) {
				System.out.println(x);
			}
		}
	}
